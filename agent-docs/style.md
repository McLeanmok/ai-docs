...
- 5 colours max
- input the values both in OKLCH, and HEX
- Label the colours like this:
        - primary 
        - secondary
        - tertiary
        - neutral 
- Return the OKLCH values in a CSS variable map. You can just list the HEX codes
- Don't use colors that are overused


## Fonts
Go to [Google Fonts](https://fonts.google.com), and select **3-5** interesting font combinations (do not be basic), and place the @import statements in the "style-guide.md" file. 

If possible, grab the font files, and place them into a subfolder in styles called "fonts". Please rip download files as woff and woff2 formats.
favor fonts which are sans-serif. The font face should be interesting, and easily readable. 

don't, under any circumstances, recommend the following fonts.
- Ariel
- Calibri
- Times New Roman 
- Comic Sans
